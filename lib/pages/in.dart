...
class _InPageState extends State<InPage> {
  ...
  get_one(spare_id) async{
      ...
      if(r != null && r.data !=null && r.data['spare_id'] == spare_id){
        setState(() {
          spare_name_controller.text = r.data['name'];
          spare_sub_name_controller.text = r.data['sub_name'];
          net_type_controller.text = r.data['net_type'];
          factory_controller.text = r.data['factory'];
